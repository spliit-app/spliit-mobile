    ...
    <>
      ...
      <FormSection>
        <FormGroup>
          ...
          />
          <HelpText>
            Set the base URL of your Spliit instance. If you're using the
            official instance, you don't need to change this setting.
          </HelpText>
          {errors.baseUrl && (
            <ErrorMessage>{errors.baseUrl.message}</ErrorMessage>
          )}
        </FormGroup>
      </FormSection>
